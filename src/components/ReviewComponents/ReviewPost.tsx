...
const ReviewPost = ({ navigation, review, children }: { navigation?: NavigationProp<any>, review: TReview, children?: ReactNode }) => {
            ...
            >
                ...
                >
                    ...
                    <Text
                        ...
                        textAlign='right'
                    >
                        {review ? formatDate(review.date): <></>} { review ? getHour(review.date): <></>}
                    </Text>
                    <HStack
