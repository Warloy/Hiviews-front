...
import { TCategory, TThread } from "@/types/Post.Type";
...
const EditThreadComponent = ({ thread }: { thread: TThread }) => {
  ...
  const [tags, setTags] = useState<TCategory | null>(thread.category);
        ...
        >
          ...
          >
            <Text
              color={colors.gray1}
            >
              Tu thread permanecerá visible para todos
            </Text>
          </Stack>
...
export default EditThreadComponent;